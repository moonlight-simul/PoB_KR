...
local localFiles = { }
local localManXML = xml.LoadXMLFile(scriptPath.."/Krbuild/manifest_kr.xml")
local localSource
local runtimeExecutable
if localManXML and localManXML[1].elem == "PoB_kr" then
...
local remoteFiles = { }
local remoteSources = { }
local remoteManText, errMsg = downloadFileText(localSource.."Krbuild/manifest_kr.xml")
...
if remoteManXML and remoteManXML[1].elem == "PoB_kr" then
...
-- Download changelog
ConPrintf("scriptPath %s",scriptPath)
downloadFile(localSource.."Krbuild/changelog.txt", scriptPath.."/Krbuild/changelog.txt")
...
xml.SaveXMLFile(localManXML, scriptPath.."/Update/manifest_kr.xml")
...
table.insert(ops, 'move "'..scriptPath..'/Update/manifest_kr.xml" "'..scriptPath..'/Krbuild/manifest_kr.xml"')
